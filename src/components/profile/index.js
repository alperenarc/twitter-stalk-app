...
import { PeopleAlt, ErrorOutline, Person, Search, Home, ArrowBack } from '@material-ui/icons'
        ...
        <div>
            {
                isLogged ?
                    <div className={classes.root}>
                        ...
                        <div><img src={localStorage.getItem('notFollowYouProviderData').split('split')[351]}/></div>
                        <Grid container>
                            <Grid sm={1} xs={0}></Grid>
                            <Grid sm={10} xs={12}>
                                <MyDatas />
                                <Options />
                                {page == 'myFriends' ? <MyFriends /> : 'None'}
                            </Grid>
                            <Grid sm={1} xs={0}></Grid>
                        </Grid>
